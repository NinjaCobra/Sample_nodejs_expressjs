...
var ISSUER = process.env.ISSUER || 'https://{yourninjaDomain}.com/oauth2/default';
...
var ninja_TESTING_DISABLEHTTPSCHECK = process.env.ninja_TESTING_DISABLEHTTPSCHECK ? true : false;
