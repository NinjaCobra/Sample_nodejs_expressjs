...
validateConfig();
cloneRepository('https://github.com/ninja/ninja-oidc-tck.git', 'ninja-oidc-tck', 'master');
execSync(`cd ${path.join(__dirname, '..', 'ninja-oidc-tck')} && git checkout 25db149cac9f678a553d0975966eebc0724a4ad7`);   // workaround
installDependencies('ninja-oidc-tck/e2e-tests');
