...
function run_tests() {
  ...
  create_log_group "ninja Hosted E2E"
  # npm run test:ninja-hosted-login
  ./node_modules/.bin/protractor ninja-oidc-tck/e2e-tests/ninja-hosted-login/conf.js
  finish_log_group $?
  ...
  ./node_modules/.bin/protractor ninja-oidc-tck/e2e-tests/custom-login/conf.js
  finish_log_group $?
}
