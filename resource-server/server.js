...
const ninjaJwtVerifier = require('@ninja/jwt-verifier');
var cors = require('cors');

const sampleConfig = require('../config.js');

const ninjaJwtVerifier = new ninjaJwtVerifier({
...
function authenticationRequired(req, res, next) {
  ...
  return ninjaJwtVerifier.verifyAccessToken(accessToken, audience)
    .then((jwt) => {
      req.jwt = jwt;
      next();
    })
